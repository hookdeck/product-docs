...
<Tabs
  ...
  values={[
    { label: 'Using Dashboard', value: 'dashboard', },
    { label: 'Using API', value: 'api', },
  ]
}>
...
[API reference →](https://https://docs.hookdeck.io/#create-a-webhook-with-an-undefined-destination-source-and-ruleset)
